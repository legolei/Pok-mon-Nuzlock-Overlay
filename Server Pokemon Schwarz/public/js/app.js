// Vollständige POKEMON_LIST mit Gen 1-9
const POKEMON_LIST = ['',
// Gen 1 (Kanto) - #001-151
...
function getSpriteUrl(name) {
  ...
  // Gen 1–5: animierte Sprites
  if (idx <= 649) {
    return `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/${idx}.gif`;
  }
  // Gen 6+: statische Sprites (größere Version)
